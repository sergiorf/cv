...
\end{itemize}
 ...
 \item Design and development of Artemis$\copyright$, a C\#/C++ Windows-based client-server Warehouse Automation System, specialized in large commodity warehouses, and Atlas©, a Visual Warehouse and BPMN authoring tool. This system supports 24x7 operation and is present in dozens of sites throughout Brazil. Our main customers are VLI Logistics, NovaAgri and Heringer. More than 5mt of grain, sugar and fertilizer processed by Artemis© in 2017.
...
{\bf IT Quant,} BNP Paribas Fortis, Brussels, Belgium \hfill  Jan 05 - Mar 09
\begin{itemize} \itemsep -2pt %reduce space between items

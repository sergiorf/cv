...
\section{Experience}
 ...
 \item Member of a multidisciplinary HW-SW team designing test systems for OEMs building products with Qorvo silicon integrated. 
 \item Lead software developer of the Test Development Kit©. A low-cost software-defined radio system, custom designed to validate the Zigbee and BLE PHY perfomance of Qorvo radio chips in low cost, high volume OEM's factories. The board is based on a STM32 MCU, an FPGA and an in-house radio chip.
 \item Main software architect of the platform in close collaboration with the hardware team.
 \item Responsible for ensuring that the project is delivered within schedule and specs. Manage resources. Plan future road-map. Write documentation and provide internal training.

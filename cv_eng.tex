...
\end{itemize}
 ...
 {\bf Software Engineer,} SIACON, Goiânia, Brazil \hfill Jul 14 - Apr 18
\newline
 {\bf Software Engineer,} SIACON, Goiânia, Brazil \hfill Dec 12 - Feb 13
...
\end{itemize}
 ...
 {\bf Software Engineer,} Oobj Tecnologia, Goiânia, Brazil \hfill Mar 13 - Jun 14
 \begin{itemize} \itemsep -2pt  % reduce space between items
 \item Designed the backend for a government website. Optimization of the real-time data processing stack of the company. Machine learning research for potential new products.
 \item Toolchain: Java 7, PotgreSQL, Eclipse, Lucene, Solr, Subversion.
 \end{itemize}

 {\bf Software Engineer,} TEIN Technology, Brussels, Belgium \hfill Oct 11 - Nov 12
 \begin{itemize} \itemsep -2pt  % reduce space between items

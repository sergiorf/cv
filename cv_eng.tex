...
\section{Experience}
 ...
 \item Member of a multidisciplinary HW-SW team designing test systems for OEMs that integrate Qorvo silicon in their products.
 \item Lead software developer of the Test Development Kit$\copyright$. A low-cost software-defined RF transceiver system, custom designed to validate the Zigbee and BLE PHY perfomance of Qorvo radio chips in low cost, high volume OEM's production flows. The board is based on a STM32 MCU, an FPGA and an in-house radio chip.
